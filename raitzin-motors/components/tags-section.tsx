  ...
  return (
    <section className="py-12 md:py-20 bg-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
        <h2 className="text-3xl md:text-4xl font-bold text-navy font-sans mb-12">
          Quiero un auto...
        </h2>
        <div className="flex flex-wrap justify-center gap-3">
          {tags.map((tag) => (
            <button
              ...
              className="px-6 py-3.5 rounded-full border border-navy text-navy bg-white text-base font-medium transition-colors duration-200 hover:bg-navy hover:text-white cursor-pointer min-h-[44px]"
            >
              {tag.label}
            </button>
          ))}
